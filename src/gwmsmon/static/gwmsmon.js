...
(function() {
  ...
  function renderSiteMonitorChart(el, series) {
    ...
    var opts = {
      ...
      series: [
        {},
        { scale: 'cpus', stroke: TIER0_COLOR, fill: TIER0_COLOR + '80', width: 1.5, label: 'Tier0', _color: TIER0_COLOR },
        { scale: 'cpus', stroke: PROD_COLOR, fill: PROD_COLOR + '80', width: 1.5, label: 'Production', _color: PROD_COLOR },
        { scale: 'cpus', stroke: ANA_COLOR, fill: ANA_COLOR + '80', width: 1.5, label: 'Analysis', _color: ANA_COLOR },
        { scale: 'cpus', stroke: OTHER_COLOR, fill: OTHER_COLOR + '80', width: 1.5, label: 'Other', _color: OTHER_COLOR },
